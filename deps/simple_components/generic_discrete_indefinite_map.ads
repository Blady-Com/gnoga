...
--
--  This  package defines  the type Map  of discrete keys  to indefinite
--  objects. The package is generic:
--
...
--
   function Is_Not_In (Container : Map; From, To : Key_Type)
      return Boolean;
--
-- Range_Get -- Get an item by range index
--
--    Container - The map
...
--
   function Range_Get (Container : Map; Index : Positive)
      return Object_Type;
--
-- Range_Remove -- Remove range of keys from the map by its index
--
--    Container - The map
...
--
-- Range_Replace -- Replace an range in the map by its index
--
