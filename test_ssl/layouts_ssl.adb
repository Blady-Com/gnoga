...
procedure Layouts_SSL is
   ...
   begin
      ...
      App.Docks.Fill_Dock (Pointer_To_View_Base_Class (Dex));
      ...
      Dex.Top_Dock (Pointer_To_View_Base_Class (Tabs));
      ...
      V.Put_Line ("Here");
      App.Docks.Top_Dock (Pointer_To_View_Base_Class (V));
      ...
      V.Put_Line ("Here");
      App.Docks.Bottom_Dock (Pointer_To_View_Base_Class (V));
      ...
      V.Put_Line ("Here");
      App.Docks.Left_Dock (Pointer_To_View_Base_Class (V));
      ...
      V.Put_Line ("Here");
      App.Docks.Right_Dock (Pointer_To_View_Base_Class (V));
