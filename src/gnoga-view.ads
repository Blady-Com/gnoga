...
package Gnoga.View is

   -------------------------------------------------------------------------
   --  View_Types
   -------------------------------------------------------------------------

   type View_Type is new Gnoga.Element.Element_Type with private;
   ...
   procedure Create (View    : in out View_Type;
   ...
   procedure On_Child_Added (View  : in out View_Type;
                             Child : in out Gnoga.Base.Base_Type'Class);
...
private
   type View_Type is new Gnoga.Element.Element_Type with null record;
end Gnoga.View;
