...
package body Strings_Edit.UTF8.Windows_1258 is
   ...
   begin
      case Stream_Element (Character'Pos (Value)) is
         ...
         when 16#D2# => return 16#0309#;
         when 16#D3# => return 16#00D3#;
         when 16#D4# => return 16#00D4#;
         when 16#D5# => return 16#01A0#;
         ...
         when 16#DD# => return 16#01AF#;
         when 16#DE# => return 16#0303#;
         ...
         when 16#F2# => return 16#0323#;
         when 16#F3# => return 16#00F3#;
         when 16#F4# => return 16#00F4#;
         when 16#F5# => return 16#01A1#;
         ...
         when 16#FD# => return 16#01B0#;
         when 16#FE# => return 16#20AB#;
   ...
   begin
      ...
      case Code is
         ...
         when 16#0300# => Value := Character'Val (16#CC#);
         ...
         when 16#0309# => Value := Character'Val (16#D2#);
         when 16#00D3# => Value := Character'Val (16#D3#);
         when 16#00D4# => Value := Character'Val (16#D4#);
         when 16#01A0# => Value := Character'Val (16#D5#);
         ...
         when 16#01AF# => Value := Character'Val (16#DD#);
         when 16#0303# => Value := Character'Val (16#DE#);
         ...
         when 16#0301# => Value := Character'Val (16#EC#);
         ...
         when 16#0323# => Value := Character'Val (16#F2#);
         when 16#00F3# => Value := Character'Val (16#F3#);
         when 16#00F4# => Value := Character'Val (16#F4#);
         when 16#01A1# => Value := Character'Val (16#F5#);
         ...
         when 16#01B0# => Value := Character'Val (16#FD#);
         when 16#20AB# => Value := Character'Val (16#FE#);
         when 16#00FF# => Value := Character'Val (16#FF#);
         when others   => Valid := False;
      end case;
   end Convert;

   function From_Windows_1258 (Value : Character) return Code_Point is
   ...
   function From_Windows_1258 (Value : String) return String is
      Result  : String (1..Value'Length * 2);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_Windows_1258 (Value));
      end loop;
   ...
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_Windows_1258 (Value, Substitute));
      end loop;
      return Result (1..Pointer - 1);
   end From_Windows_1258;

   function From_Windows_1258 (Value : String) return Wide_String is
      Result  : Wide_String (1..Value'Length);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val (From_Windows_1258 (Value (Index)));
         Pointer := Pointer + 1;
      end loop;
      return Result;
   end From_Windows_1258;
   ...
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val
            (  From_Windows_1258 (Value (Index), Default)
            );
         Pointer := Pointer + 1;
      end loop;
      return Result;
   ...
   function To_Windows_1258 (Value : Code_Point) return Character is
      Result : Character;
      Valid  : Boolean;
   begin
   ...
   function To_Windows_1258 (Value : String) return String is
   ...
   begin
      while Pointer <= Value'Last loop
         ...
         Result (Index) := To_Windows_1258 (Code);
         Index := Index + 1;
      end loop;
   ...
   begin
      while Pointer <= Value'Last loop
         Get (Value, Pointer, Code);
         Result (Index) := To_Windows_1258 (Code, Substitute);
         Index := Index + 1;
      end loop;
      return Result (1..Index - 1);
   end To_Windows_1258;

   function To_Windows_1258 (Value : Wide_String) return String is
      Result : String (1..Value'Length);
      Index  : Integer := 1;
   begin
      for Pointer in Value'Range loop
         Result (Index) :=
            To_Windows_1258 (Wide_Character'Pos (Value (Pointer)));
         Index := Index + 1;
      end loop;
      return Result;
   end To_Windows_1258;
