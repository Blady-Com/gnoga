...
package Gnoga.Element.SVG is
   -------------------------------------------------------------------------
   --  SVG_Types
   -------------------------------------------------------------------------

   type SVG_Type is new Gnoga.Element.Element_Type with private;
...
private
   type SVG_Type is new Gnoga.Element.Element_Type with null record;
