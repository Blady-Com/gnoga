...
--     Strings_Edit.UTF8.Windows_1250              Luebeck            --
...
package body Strings_Edit.UTF8.Windows_1250 is
   ...
   begin
      case Stream_Element (Character'Pos (Value)) is
         ...
         when 16#8D# => return 16#0164#; 
         when 16#8E# => return 16#017D#; 
         when 16#8F# => return 16#0179#; 
         ...
         when 16#9C# => return 16#015B#; 
         when 16#9D# => return 16#0165#; 
         when 16#9E# => return 16#017E#; 
         when 16#9F# => return 16#017A#; 
         when 16#A0# => return 16#00A0#;
         when 16#A1# => return 16#02C7#;
         when 16#A2# => return 16#02D8#;
         when 16#A3# => return 16#0141#;
         when 16#A4# => return 16#00A4#;
         when 16#A5# => return 16#0104#;
         ...
         when 16#B9# => return 16#0105#;
         when 16#BA# => return 16#015F#;
         when 16#BB# => return 16#00BB#;
         when 16#BC# => return 16#013D#;
         when 16#BD# => return 16#02DD#;
         when 16#BE# => return 16#013E#;
   ...
   begin
      ...
      case Code is
         ...
         when 16#0164# => Value := Character'Val (16#8D#);
         when 16#017D# => Value := Character'Val (16#8E#);
         when 16#0179# => Value := Character'Val (16#8F#);
         ...
         when 16#015B# => Value := Character'Val (16#9C#);
         when 16#0165# => Value := Character'Val (16#9D#);
         when 16#017E# => Value := Character'Val (16#9E#);
         when 16#017A# => Value := Character'Val (16#9F#);
         when 16#00A0# => Value := Character'Val (16#A0#);
         when 16#02C7# => Value := Character'Val (16#A1#);
         when 16#02D8# => Value := Character'Val (16#A2#);
         when 16#0141# => Value := Character'Val (16#A3#);
         when 16#00A4# => Value := Character'Val (16#A4#);
         when 16#0104# => Value := Character'Val (16#A5#);
         ...
         when 16#0105# => Value := Character'Val (16#B9#);
         when 16#015F# => Value := Character'Val (16#BA#);
         when 16#00BB# => Value := Character'Val (16#BB#);
         when 16#013D# => Value := Character'Val (16#BC#);
         when 16#02DD# => Value := Character'Val (16#BD#);
         when 16#013E# => Value := Character'Val (16#BE#);
   ...
   function From_Windows_1250 (Value : Character) return Code_Point is
   ...
   function From_Windows_1250 (Value : String) return String is
      Result  : String (1..Value'Length * 2);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_Windows_1250 (Value));
      end loop;
   ...
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_Windows_1250 (Value, Substitute));
      end loop;
      return Result (1..Pointer - 1);
   end From_Windows_1250;

   function From_Windows_1250 (Value : String) return Wide_String is
      Result  : Wide_String (1..Value'Length);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val (From_Windows_1250 (Value (Index)));
         Pointer := Pointer + 1;
      end loop;
      return Result;
   end From_Windows_1250;
   ...
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val
            (  From_Windows_1250 (Value (Index), Default)
            );
         Pointer := Pointer + 1;
      end loop;
      return Result;
   ...
   function To_Windows_1250 (Value : Code_Point) return Character is
      Result : Character;
      Valid  : Boolean;
   begin
   ...
   function To_Windows_1250 (Value : String) return String is
   ...
   begin
      while Pointer <= Value'Last loop
         ...
         Result (Index) := To_Windows_1250 (Code);
         Index := Index + 1;
      end loop;
   ...
   begin
      while Pointer <= Value'Last loop
         Get (Value, Pointer, Code);
         Result (Index) := To_Windows_1250 (Code, Substitute);
         Index := Index + 1;
      end loop;
      return Result (1..Index - 1);
   end To_Windows_1250;

   function To_Windows_1250 (Value : Wide_String) return String is
      Result : String (1..Value'Length);
      Index  : Integer := 1;
   begin
      for Pointer in Value'Range loop
         Result (Index) :=
            To_Windows_1250 (Wide_Character'Pos (Value (Pointer)));
         Index := Index + 1;
      end loop;
      return Result;
   end To_Windows_1250;
...
end Strings_Edit.UTF8.Windows_1250;
