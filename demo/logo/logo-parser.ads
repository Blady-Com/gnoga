...
package Logo.Parser is
   ...
   function Check_Matched (Source : String; Pointer : Integer) return Boolean;
   ...
   procedure Get_Token is new Parsers.String_Source.Code.Get_Token
     (Primitive_Tables_Raw);
