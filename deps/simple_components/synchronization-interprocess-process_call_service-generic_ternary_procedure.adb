...
package body Synchronization.Interprocess.Process_Call_Service.
   ...
   procedure Call
      ...
      begin
         ...
         Argument_3_Type'Output (Stream'Access, Argument_3);
      end Send_Parameters;
   ...
   procedure Call
      ...
      begin
         ...
         Argument_3_Type'Read (Stream'Access, Argument_3);
      end Receive_Results;
   ...
   procedure Execute
      ...
      Argument_3 : constant Argument_3_Type :=
                            Argument_3_Type'Input (Parameters'Access);
   begin
   ...
   begin
      if Method.Handler = null then
         ...
         Argument_3_Type'Write (Results'Access, Argument_3);
      end if;
   end Execute;
