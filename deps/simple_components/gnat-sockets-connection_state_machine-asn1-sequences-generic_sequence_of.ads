...
--
-- [Implicit_]Sequence_Of -- Sequence of values
--
   type Sequence_Of is
...
--
-- Append -- Append a new element to the sequence
--
--    Item  - The sequence
...
--    Use_Error     - The sequence is not initialized
--
   procedure Append
...
--
-- Set -- Set element of the sequence
--
--    Item  - The sequence
--    Index - Of the element 1..Get_Length
--    Value - To set
