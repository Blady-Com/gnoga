...
--
-- From_ISO_8859_10 -- Conversion from ISO/IEC 8859-10
--
--    Value        - Character or a ISO/IEC 8859-10 string
--  [ Substitute ] - For unused codes
--
-- These functions convert the parameter Value from ISO 8859-10.
--
-- Returns :
--
...
-- Exceptions :
--
--    Constraint_Error - Unused ISO/IEC 8859-10 code
--
   function From_ISO_8859_10 (Value : Character) return Code_Point;
   function From_ISO_8859_10
            (  Value      : Character;
               Substitute : Code_Point
            )  return Code_Point;
   function From_ISO_8859_10 (Value : String) return String;
   function From_ISO_8859_10
            (  Value      : String;
               Substitute : Code_Point
            )  return String;
   function From_ISO_8859_10 (Value : String) return Wide_String;
   function From_ISO_8859_10
            (  Value      : String;
               Substitute : Wide_Character
            )  return Wide_String;
--
-- To_ISO_8859_10 -- Conversion to ISO 8859-10
--
--    Value        - The UTF-8 string to convert
--  [ Substitute ] - For unsupported code points
--
-- These   functions  convert to  ISO/IEC 8859-10 character string.  The
...
--
   function To_ISO_8859_10 (Value : Code_Point) return Character;
   function To_ISO_8859_10
            (  Value      : Code_Point;
               Substitute : Character
            )  return Character;
   function To_ISO_8859_10 (Value : String) return String;
   function To_ISO_8859_10
            (  Value      : String;
               Substitute : Character
            )  return String;
   function To_ISO_8859_10 (Value : Wide_String) return String;
   function To_ISO_8859_10
            (  Value      : Wide_String;
               Substitute : Character
            )  return String;
