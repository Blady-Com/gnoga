...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_websocket_duplex_server" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9d334826#;
   pragma Export (C, u00001, "test_websocket_duplex_serverB");
   ...
   u00215 : constant Version_32 := 16#2ab038fc#;
   pragma Export (C, u00215, "test_websocket_duplex_serversB");
   u00216 : constant Version_32 := 16#6d6a4f54#;
   pragma Export (C, u00216, "test_websocket_duplex_serversS");
   u00217 : constant Version_32 := 16#0598743c#;
   pragma Export (C, u00217, "strings_edit__quotedB");
   u00218 : constant Version_32 := 16#ce827f1f#;
   pragma Export (C, u00218, "strings_edit__quotedS");
   u00219 : constant Version_32 := 16#98ac7b90#;
   pragma Export (C, u00219, "strings_edit__fieldsB");
   u00220 : constant Version_32 := 16#0b9cc63b#;
   pragma Export (C, u00220, "strings_edit__fieldsS");
   u00221 : constant Version_32 := 16#9e8a3eec#;
   pragma Export (C, u00221, "gnat__sockets__connection_state_machineB");
   u00222 : constant Version_32 := 16#3c2e4980#;
   pragma Export (C, u00222, "gnat__sockets__connection_state_machineS");
   u00223 : constant Version_32 := 16#c571ff30#;
   pragma Export (C, u00223, "gnat__sockets__connection_state_machine__http_serverB");
   u00224 : constant Version_32 := 16#cf5572e7#;
   pragma Export (C, u00224, "gnat__sockets__connection_state_machine__http_serverS");
   ...
   u00228 : constant Version_32 := 16#077f0b47#;
   pragma Export (C, u00228, "gnat__sha1B");
   u00229 : constant Version_32 := 16#6e14b0a7#;
   pragma Export (C, u00229, "gnat__sha1S");
   u00230 : constant Version_32 := 16#133318a1#;
   pragma Export (C, u00230, "gnat__secure_hashesB");
   u00231 : constant Version_32 := 16#76ee2707#;
   pragma Export (C, u00231, "gnat__secure_hashesS");
   u00232 : constant Version_32 := 16#cadfacae#;
   pragma Export (C, u00232, "gnat__secure_hashes__sha1B");
   u00233 : constant Version_32 := 16#a1cfcd9e#;
   pragma Export (C, u00233, "gnat__secure_hashes__sha1S");
   u00234 : constant Version_32 := 16#45efda4c#;
   pragma Export (C, u00234, "gnat__byte_swappingB");
   u00235 : constant Version_32 := 16#ab0a1c41#;
   pragma Export (C, u00235, "gnat__byte_swappingS");
   u00236 : constant Version_32 := 16#8b6eacc9#;
   pragma Export (C, u00236, "system__byte_swappingS");
   u00237 : constant Version_32 := 16#e40edcb6#;
   pragma Export (C, u00237, "gnat__sockets__connection_state_machine__big_endianS");
   u00238 : constant Version_32 := 16#bf2f42ad#;
   pragma Export (C, u00238, "gnat__sockets__connection_state_machine__big_endian__unsignedsB");
   u00239 : constant Version_32 := 16#f1a816f2#;
   pragma Export (C, u00239, "gnat__sockets__connection_state_machine__big_endian__unsignedsS");
   u00240 : constant Version_32 := 16#ebbe1dbe#;
   pragma Export (C, u00240, "strings_edit__base64B");
   u00241 : constant Version_32 := 16#3f0fc4fb#;
   pragma Export (C, u00241, "strings_edit__base64S");
   u00242 : constant Version_32 := 16#bf9cfb94#;
   pragma Export (C, u00242, "strings_edit__floatsB");
   u00243 : constant Version_32 := 16#707fba21#;
   pragma Export (C, u00243, "strings_edit__floatsS");
   u00244 : constant Version_32 := 16#84ad4a42#;
   pragma Export (C, u00244, "ada__numericsS");
   u00245 : constant Version_32 := 16#03e83d1c#;
   pragma Export (C, u00245, "ada__numerics__elementary_functionsB");
   u00246 : constant Version_32 := 16#47bfe5ef#;
   pragma Export (C, u00246, "ada__numerics__elementary_functionsS");
   u00247 : constant Version_32 := 16#3e0cf54d#;
   pragma Export (C, u00247, "ada__numerics__auxB");
   u00248 : constant Version_32 := 16#9f6e24ed#;
   pragma Export (C, u00248, "ada__numerics__auxS");
   u00249 : constant Version_32 := 16#2dc906b9#;
   pragma Export (C, u00249, "system__fat_llfS");
   u00250 : constant Version_32 := 16#fd49a347#;
   pragma Export (C, u00250, "system__machine_codeS");
   u00251 : constant Version_32 := 16#0be1b996#;
   pragma Export (C, u00251, "system__exn_llfB");
   u00252 : constant Version_32 := 16#7376c666#;
   pragma Export (C, u00252, "system__exn_llfS");
   u00253 : constant Version_32 := 16#712ba15e#;
   pragma Export (C, u00253, "system__fat_fltS");
   u00254 : constant Version_32 := 16#0a12f050#;
   pragma Export (C, u00254, "strings_edit__float_editB");
   u00255 : constant Version_32 := 16#cfe341b5#;
   pragma Export (C, u00255, "strings_edit__float_editS");
   u00256 : constant Version_32 := 16#5aac8b31#;
   pragma Export (C, u00256, "strings_edit__utf8B");
   u00257 : constant Version_32 := 16#d5db5807#;
   pragma Export (C, u00257, "strings_edit__utf8S");
   u00258 : constant Version_32 := 16#78cb869e#;
   pragma Export (C, u00258, "system__concat_9B");
   u00259 : constant Version_32 := 16#2eb8ecad#;
   pragma Export (C, u00259, "system__concat_9S");
   u00260 : constant Version_32 := 16#46b1f5ea#;
   pragma Export (C, u00260, "system__concat_8B");
   u00261 : constant Version_32 := 16#11f5955e#;
   pragma Export (C, u00261, "system__concat_8S");
   u00262 : constant Version_32 := 16#22ab03a2#;
   pragma Export (C, u00262, "system__img_unsB");
   u00263 : constant Version_32 := 16#3c0076d1#;
   pragma Export (C, u00263, "system__img_unsS");
   ...
   u00268 : constant Version_32 := 16#8ff77155#;
   pragma Export (C, u00268, "system__val_realB");
   u00269 : constant Version_32 := 16#0cdbaf98#;
   pragma Export (C, u00269, "system__val_realS");
   u00270 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00270, "system__float_controlB");
   u00271 : constant Version_32 := 16#120e9bb5#;
   pragma Export (C, u00271, "system__float_controlS");
   u00272 : constant Version_32 := 16#a282befe#;
   pragma Export (C, u00272, "system__powten_tableS");
   u00273 : constant Version_32 := 16#5cf80e25#;
   pragma Export (C, u00273, "ada__task_identificationB");
   u00274 : constant Version_32 := 16#9ad8d545#;
   pragma Export (C, u00274, "ada__task_identificationS");
   u00275 : constant Version_32 := 16#f7029c34#;
   pragma Export (C, u00275, "generic_discrete_setB");
   u00276 : constant Version_32 := 16#5b503d69#;
   pragma Export (C, u00276, "generic_discrete_setS");
   u00277 : constant Version_32 := 16#d59316cc#;
   pragma Export (C, u00277, "generic_setB");
   u00278 : constant Version_32 := 16#5a9ca29d#;
   pragma Export (C, u00278, "generic_setS");
   u00279 : constant Version_32 := 16#036ed0e3#;
   pragma Export (C, u00279, "gnat__sockets__connection_state_machine__expected_sequenceB");
   u00280 : constant Version_32 := 16#1112fc75#;
   pragma Export (C, u00280, "gnat__sockets__connection_state_machine__expected_sequenceS");
   u00281 : constant Version_32 := 16#743971fd#;
   pragma Export (C, u00281, "gnat__sockets__connection_state_machine__terminated_stringsB");
   u00282 : constant Version_32 := 16#68dc845b#;
   pragma Export (C, u00282, "gnat__sockets__connection_state_machine__terminated_stringsS");
   u00283 : constant Version_32 := 16#0bf4b510#;
   pragma Export (C, u00283, "system__strings__stream_opsB");
   u00284 : constant Version_32 := 16#5ed775a4#;
   pragma Export (C, u00284, "system__strings__stream_opsS");
   u00285 : constant Version_32 := 16#e5c17123#;
   pragma Export (C, u00285, "ada__streams__stream_ioB");
   u00286 : constant Version_32 := 16#68da1e56#;
   pragma Export (C, u00286, "ada__streams__stream_ioS");
   u00287 : constant Version_32 := 16#fcc0579f#;
   pragma Export (C, u00287, "stack_storageB");
   u00288 : constant Version_32 := 16#d77a936b#;
   pragma Export (C, u00288, "stack_storageS");
   u00289 : constant Version_32 := 16#9f2ee7c1#;
   pragma Export (C, u00289, "generic_unbounded_ptr_arrayB");
   u00290 : constant Version_32 := 16#6a65cc50#;
   pragma Export (C, u00290, "generic_unbounded_ptr_arrayS");
   u00291 : constant Version_32 := 16#5dbee6d7#;
   pragma Export (C, u00291, "tablesB");
   u00292 : constant Version_32 := 16#e9c0911e#;
   pragma Export (C, u00292, "tablesS");
   u00293 : constant Version_32 := 16#6d8e325b#;
   pragma Export (C, u00293, "tables__namesB");
   u00294 : constant Version_32 := 16#4de14fef#;
   pragma Export (C, u00294, "tables__namesS");
   ...
   --  test_websocket_duplex_servers%s
   --  test_websocket_duplex_servers%b
   --  test_websocket_duplex_server%b
