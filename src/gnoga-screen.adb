...
package body Gnoga.Screen is
   ...
   begin
      return Integer'Value
        (Gnoga.Connections.Execute_Script (ID, "screen.width;"));
   end Width;
   ...
   begin
      return Integer'Value
        (Gnoga.Connections.Execute_Script (ID, "screen.height;"));
   end Height;
   ...
   begin
      return Integer'Value
        (Gnoga.Connections.Execute_Script (ID, "screen.availHeight;"));
   ...
   begin
      return Integer'Value
        (Gnoga.Connections.Execute_Script (ID, "screen.availWidth;"));
   end Available_Width;
   ...
   begin
      return Integer'Value
        (Gnoga.Connections.Execute_Script (ID, "screen.colorDepth;"));
   end Color_Depth;
   ...
   begin
      return Integer'Value
        (Gnoga.Connections.Execute_Script (ID, "screen.pixelDepth;"));
   end Pixel_Depth;
