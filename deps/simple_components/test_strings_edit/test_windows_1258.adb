...
use  Strings_Edit.UTF8.Windows_1258;

procedure Test_Windows_1258 is
begin
   for Code in Character range
      ...
      case Character'Pos (Code) is
         ...
         when others =>
            if To_Windows_1258 (From_Windows_1258 (Code)) /= Code then
               Raise_Exception
               (  Data_Error'Identity,
                  (  "Encoding "
                  &  Image (Integer (Character'Pos (Code)))
