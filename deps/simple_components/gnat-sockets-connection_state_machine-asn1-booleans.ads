...
--
--  ASN.1 encoding of Boolean
--
package GNAT.Sockets.Connection_State_Machine.ASN1.Booleans is
--
-- Implicit_Boolean_Data_Item -- ASN.1 encoded Boolean
--
...
--
   procedure Set_Untagged (Item : in out Implicit_Boolean_Data_Item);
--
-- Boolean_Data_Item -- Explicit form of encoding
--
   type Boolean_Data_Item is
      new Implicit_Boolean_Data_Item with null record;
--
-- Encode -- Overrides ...Connection_State_Machine.ASN1...
--
   procedure Encode
...
-- Is_Implicit -- Overrides ...Connection_State_Machine.ASN1...
--
   function Is_Implicit (Item : Boolean_Data_Item) return Boolean;
------------------------------------------------------------------------
--
-- Get -- ASN.1 Boolean from stream element array
--
