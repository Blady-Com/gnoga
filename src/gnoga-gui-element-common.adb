...
package body Gnoga.Gui.Element.Common is
   ...
   begin
      A.Create_From_HTML
        (Parent,
         Escape_Quotes ("<a target='" & Target & "' href='" & Escape_Inner_Quotes (Link) & "'>" & Content & "</a>"),
         ID);
   end Create;
   ...
   begin
      IMG.Create_From_HTML
        (Parent,
         Escape_Quotes
           ("<img src='" & Escape_Inner_Quotes (URL_Source) & "' Alt='" & Escape_Inner_Quotes (Alternative_Text) &
            "'>"),
         ID);
   end Create;
   ...
   begin
      Meter.Create_From_HTML
        (Parent,
         "<meter high=" & Image (High) & " low=" & Image (Low) & " max=" & Image (Maximum) & " min=" & Image (Minimum) &
         " optimum=" & Image (Optimum) & " value=" & Image (Value) & " />");
   end Create;
   ...
   begin
      Progress_Bar.Create_From_HTML
        (Parent, "<progress" & " max=" & Image (Maximum) & " value=" & Image (Value) & " />");
