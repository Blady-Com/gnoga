...
--     Strings_Edit.UTF8.ISO_8859_7                Luebeck            --
...
package body Strings_Edit.UTF8.ISO_8859_7 is
   ...
   begin
      case Stream_Element (Character'Pos (Value)) is
         ...
         when 16#B5# => return 16#0385#;
         when 16#B6# => return 16#0386#;
   ...
   begin
      ...
      case Code is
         ...
         when 16#2018# => Value := Character'Val (16#A1#);
         when 16#2019# => Value := Character'Val (16#A2#);
         when 16#00A3# => Value := Character'Val (16#A3#);
         when 16#20AC# => Value := Character'Val (16#A4#);
         when 16#20AF# => Value := Character'Val (16#A5#);
         ...
         when 16#037A# => Value := Character'Val (16#AA#);
         ...
         when 16#0385# => Value := Character'Val (16#B5#);
         when 16#0386# => Value := Character'Val (16#B6#);
   ...
   function From_ISO_8859_7 (Value : Character) return Code_Point is
   ...
   function From_ISO_8859_7 (Value : String) return String is
      Result  : String (1..Value'Length * 2);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_ISO_8859_7 (Value));
      end loop;
   ...
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_ISO_8859_7 (Value, Substitute));
      end loop;
      return Result (1..Pointer - 1);
   end From_ISO_8859_7;

   function From_ISO_8859_7 (Value : String) return Wide_String is
      Result  : Wide_String (1..Value'Length);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val (From_ISO_8859_7 (Value (Index)));
         Pointer := Pointer + 1;
      end loop;
      return Result;
   end From_ISO_8859_7;
   ...
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val
            (  From_ISO_8859_7 (Value (Index), Default)
            );
         Pointer := Pointer + 1;
      end loop;
      return Result;
   ...
   function To_ISO_8859_7 (Value : Code_Point) return Character is
      Result : Character;
      Valid  : Boolean;
   begin
   ...
   function To_ISO_8859_7 (Value : String) return String is
   ...
   begin
      while Pointer <= Value'Last loop
         ...
         Result (Index) := To_ISO_8859_7 (Code);
         Index := Index + 1;
      end loop;
   ...
   begin
      while Pointer <= Value'Last loop
         Get (Value, Pointer, Code);
         Result (Index) := To_ISO_8859_7 (Code, Substitute);
         Index := Index + 1;
      end loop;
      return Result (1..Index - 1);
   end To_ISO_8859_7;

   function To_ISO_8859_7 (Value : Wide_String) return String is
      Result : String (1..Value'Length);
      Index  : Integer := 1;
   begin
      for Pointer in Value'Range loop
         Result (Index) :=
            To_ISO_8859_7 (Wide_Character'Pos (Value (Pointer)));
         Index := Index + 1;
      end loop;
      return Result;
   end To_ISO_8859_7;
...
end Strings_Edit.UTF8.ISO_8859_7;
