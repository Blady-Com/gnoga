...
package body Strings_Edit.UTF8.Windows_1254 is
   ...
   function From_Windows_1254 (Value : Character) return Code_Point is
   ...
   function From_Windows_1254 (Value : String) return String is
      Result  : String (1..Value'Length * 2);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_Windows_1254 (Value));
      end loop;
   ...
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_Windows_1254 (Value, Substitute));
      end loop;
      return Result (1..Pointer - 1);
   end From_Windows_1254;

   function From_Windows_1254 (Value : String) return Wide_String is
      Result  : Wide_String (1..Value'Length);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val (From_Windows_1254 (Value (Index)));
         Pointer := Pointer + 1;
      end loop;
      return Result;
   end From_Windows_1254;
   ...
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val
            (  From_Windows_1254 (Value (Index), Default)
            );
         Pointer := Pointer + 1;
      end loop;
      return Result;
   ...
   function To_Windows_1254 (Value : Code_Point) return Character is
      Result : Character;
      Valid  : Boolean;
   begin
   ...
   function To_Windows_1254 (Value : String) return String is
   ...
   begin
      while Pointer <= Value'Last loop
         ...
         Result (Index) := To_Windows_1254 (Code);
         Index := Index + 1;
      end loop;
   ...
   begin
      while Pointer <= Value'Last loop
         Get (Value, Pointer, Code);
         Result (Index) := To_Windows_1254 (Code, Substitute);
         Index := Index + 1;
      end loop;
      return Result (1..Index - 1);
   end To_Windows_1254;

   function To_Windows_1254 (Value : Wide_String) return String is
      Result : String (1..Value'Length);
      Index  : Integer := 1;
   begin
      for Pointer in Value'Range loop
         Result (Index) :=
            To_Windows_1254 (Wide_Character'Pos (Value (Pointer)));
         Index := Index + 1;
      end loop;
      return Result;
   end To_Windows_1254;
