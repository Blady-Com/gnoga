...
package Gnoga.Gui.View.Card is
   ...
   --  Prevent ubinding of resize event from Object by adding or removing a
   --  handler.

   procedure On_Resize (View : in out Card_View_Type);
   --  Event is used by views that handle layout of children

   overriding
   procedure On_Message (Object  : in out Card_View_Type;
                         Event   : in     String;
                         Message : in     String);
private
