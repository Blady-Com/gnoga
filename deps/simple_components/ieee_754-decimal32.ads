...
package IEEE_754.Decimal32 is
   pragma Pure (IEEE_754.Decimal32);
--
-- Decimal_32 -- 32-bit IEEE 754 decimal32 float.  The  memory layout is
...
--
-- From_IEEE -- Conversion from decimal32 IEEE 754 float
--
--    Value    - The argument
...
--
-- To_IEEE -- Conversion to decimal32 IEEE 754 float
--
--    Mantissa - The mantissa
--    Exponent - The exponent
--    Encoding - The decimal encoding method
