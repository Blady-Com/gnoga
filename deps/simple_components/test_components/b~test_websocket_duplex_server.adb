pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~test_websocket_duplex_server.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~test_websocket_duplex_server.adb");
...
package body ada_main is
   ...
   E216 : Short_Integer; pragma Import (Ada, E216, "test_websocket_duplex_servers_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "test_websocket_duplex_servers__finalize_spec");
      begin
         F1;
      end;
      E224 := E224 - 1;
   ...
   begin
      ...
      E224 := E224 + 1;
      Test_Websocket_Duplex_Servers'Elab_Spec;
      Test_Websocket_Duplex_Servers'Elab_Body;
      E216 := E216 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_test_websocket_duplex_server");
...
--  BEGIN Object file/option list
   ...
   --   /Users/dbotton/Projects/gnoga/deps/simple_components/test_components/test_websocket_duplex_servers.o
   --   /Users/dbotton/Projects/gnoga/deps/simple_components/test_components/test_websocket_duplex_server.o
