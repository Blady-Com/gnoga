...
procedure Demo is
   ...
   begin
      ...
      App.My_Input.Create (Form => App.My_Form, Size => 40);
      App.My_Input.Data_List (App.My_List);
      App.My_Input.Autocomplete;

      Label.Create (Form => App.My_Form, Label_For => App.My_Input, Content => "Type Stuff:");
      ...
      App.My_Select.Create (App.My_Form, Multiple_Select => True, Visible_Lines => 20);
      App.My_Select.Box_Width ("20em");
      App.My_Select.Add_Option (Value => "1", Text => "L1");
      App.My_Select.Add_Option (Value => "2", Text => "L2");

      Option := new Form.Option_Type;
      Option.Create (App.My_Form, App.My_Select, "3", "L3");

      App.My_Form.Add_Element (Name => "op3.5", Element => new Form.Option_Type);
      App.My_Form.Element ("op3.5").Dynamic;
      Form.Option_Access (App.My_Form.Element ("op3.5")).Create
        (Form => App.My_Form, Selection => App.My_Select, Value => "3.5", Text => "L3.5");

      App.My_Select.Add_Option (Value => "4", Text => "L4");
      App.My_Select.Add_Option (Value => "2.5", Text => "L2.5", Index => 2);

      Form.Option_Access (App.My_Form.New_Element ("op6", new Form.Option_Type)).Create
        (App.My_Form, App.My_Select, "6", "L6");

      Form.Option_Access (App.My_Form.Add (new Form.Option_Type)).Create (App.My_Form, App.My_Select, "7", "L7");
      ...
      App.Source.Border;
      App.Source.On_Drag_Start_Handler (Handler => Start_Drag'Unrestricted_Access, Drag_Text => "I've been Dragged");
      ...
      declare
         ...
         Items : View_Data;
      begin
         Set_Template_Directory (Gnoga.Server.Templates_Directory & "test" & Gnoga.Server.Directory_Separator);
