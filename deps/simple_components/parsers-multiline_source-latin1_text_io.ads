...
--  standard  text I/O package. It is intended for parsing Latin-encoded
--  files. Typically a parser would be designed to deal with UTF-8. When
--  the source is a Latin-1 file, this package can be used to handle it.
--  The package recodes the source into UTF-8 as the file is read.
--
with Ada.Text_IO;  use Ada.Text_IO;

package Parsers.Multiline_Source.Latin1_Text_IO is
--
...
private
   type Source (File : access File_Type) is
      new Parsers.Multiline_Source.Source with null record;
