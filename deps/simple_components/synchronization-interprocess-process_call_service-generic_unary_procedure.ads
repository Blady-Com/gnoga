...
--     ...Generic_Unary_Procedure                  Luebeck            --
--                                                 Spring, 2018       --
--  Interface                                                         --
...
--
--    Argument - The parameter (in and out)
--    Callee   - The local call service
--    Caller   - The remote call service
--
...
--
-- Asynchronous_Procedure -- A remote procedure with one argument called
--                           asynchronously
--
   type Asynchronous_Procedure is new Abstract_Method with private;
--
-- Synchronous_Immutable_Procedure -- A  remote   procedure   with   one
...
--
-- Synchronous_Mutable_Procedure -- A remote procedure with  one mutable
