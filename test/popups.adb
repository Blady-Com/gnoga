...
procedure Popups is
   ...
   type App_Data2 is new Connection_Data_Type with record
      Main_Window : Window.Pointer_To_Window_Class;
      New_Div     : Common.DIV_Type;
   end record;
   ...
   begin
      Connection.Execute_Script (Object.Connection_ID, "newWin = window.open ('/demo');");
      Connection.Execute_Script (Object.Connection_ID, "newWin2 = window.open ('/no_boot.html');");
   ...
   begin
      ...
      W2.Attach (Connection_ID => Object.Connection_ID, ID => "newWin2");
      ...
      App.New_Div2.Place_Inside_Top_Of (App.Chld_Window.Document.Body_Element.all);
