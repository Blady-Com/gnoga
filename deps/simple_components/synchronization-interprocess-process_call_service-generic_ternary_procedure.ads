...
--     ...Generic_Ternary_Procedure                Luebeck            --
--                                                 Spring, 2018       --
--  Interface                                                         --
...
--    Argument_3 - The third parameter  (in and out)
--    Callee     - The local call service
--    Caller     - The remote call service
--
...
--
-- Asynchronous_Procedure -- A  remote  procedure with  three  arguments
--                           called asynchronously
--
   type Asynchronous_Procedure is new Abstract_Method with private;
--
-- Synchronous_Immutable_Procedure -- A  remote   procedure  with  three
...
--
-- Synchronous_Mutable_Procedure -- A   remote   procedure   with  three
--                                  mutable       argument        called
--                                  synchronously
--
