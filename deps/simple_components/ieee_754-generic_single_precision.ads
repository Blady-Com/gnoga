...
package IEEE_754.Generic_Single_Precision is
   pragma Pure (IEEE_754.Generic_Single_Precision);
--
-- Float_32 -- 32-bit single-precision IEEE 754 float. The memory layout
...
private
   ...
   Positive_Infinity : constant Float_32 := (16#7F#,16#80#,0,0);
   Positive_Zero     : constant Float_32 := (others => 0);
