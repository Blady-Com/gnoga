...
package Gnoga.Server.Database.MySQL is
   ...
   type Recordset (Server_ID : MySQL_ID) is new Gnoga.Server.Database.Recordset with private;
...
private
   ...
   type Recordset (Server_ID : MySQL_ID) is new Gnoga.Server.Database.Recordset with record
