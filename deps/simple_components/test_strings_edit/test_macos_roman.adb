...
use  Strings_Edit.UTF8.MacOS_Roman;

procedure Test_MacOS_Roman is
begin
   for Code in Character range
               Character'Val (0)..Character'Val (255) loop
      if To_MacOS_Roman (From_MacOS_Roman (Code)) /= Code then
          Raise_Exception
          (  Data_Error'Identity,
             (  "Encoding "
