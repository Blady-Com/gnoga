...
package body Strings_Edit.UTF8.ISO_8859_4 is
   ...
   begin
      case Stream_Element (Character'Pos (Value)) is
         ...
         when 16#A2# => return 16#0138#;
         when 16#A3# => return 16#0156#;
         when 16#A4# => return 16#00A4#;
         when 16#A5# => return 16#0128#;
         when 16#A6# => return 16#013B#;
         when 16#A7# => return 16#00A7#;
         when 16#A8# => return 16#00A8#;
         when 16#A9# => return 16#0160#;
         when 16#AA# => return 16#0112#;
         when 16#AB# => return 16#0122#;
         when 16#AC# => return 16#0166#;
         ...
         when 16#B3# => return 16#0157#;
         when 16#B4# => return 16#00B4#;
         when 16#B5# => return 16#0129#;
         when 16#B6# => return 16#013C#;
         when 16#B7# => return 16#02C7#;
         when 16#B8# => return 16#00B8#;
         when 16#B9# => return 16#0161#;
         when 16#BA# => return 16#0113#;
         when 16#BB# => return 16#0123#;
         when 16#BC# => return 16#0167#;
         when 16#BD# => return 16#014A#;
         ...
         when 16#DD# => return 16#0168#;
         when 16#DE# => return 16#016A#;
         ...
         when 16#FD# => return 16#0169#;
         when 16#FE# => return 16#016B#;
   ...
   begin
      ...
      case Code is
         ...
         when 16#0138# => Value := Character'Val (16#A2#);
         when 16#0156# => Value := Character'Val (16#A3#);
         when 16#00A4# => Value := Character'Val (16#A4#);
         when 16#0128# => Value := Character'Val (16#A5#);
         when 16#013B# => Value := Character'Val (16#A6#);
         when 16#00A7# => Value := Character'Val (16#A7#);
         when 16#00A8# => Value := Character'Val (16#A8#);
         when 16#0160# => Value := Character'Val (16#A9#);
         when 16#0112# => Value := Character'Val (16#AA#);
         when 16#0122# => Value := Character'Val (16#AB#);
         when 16#0166# => Value := Character'Val (16#AC#);
         ...
         when 16#0157# => Value := Character'Val (16#B3#);
         when 16#00B4# => Value := Character'Val (16#B4#);
         when 16#0129# => Value := Character'Val (16#B5#);
         when 16#013C# => Value := Character'Val (16#B6#);
         when 16#02C7# => Value := Character'Val (16#B7#);
         when 16#00B8# => Value := Character'Val (16#B8#);
         when 16#0161# => Value := Character'Val (16#B9#);
         when 16#0113# => Value := Character'Val (16#BA#);
         when 16#0123# => Value := Character'Val (16#BB#);
         when 16#0167# => Value := Character'Val (16#BC#);
         when 16#014A# => Value := Character'Val (16#BD#);
         ...
         when 16#0168# => Value := Character'Val (16#DD#);
         when 16#016A# => Value := Character'Val (16#DE#);
         ...
         when 16#0169# => Value := Character'Val (16#FD#);
         when 16#016B# => Value := Character'Val (16#FE#);
         when 16#02D9# => Value := Character'Val (16#FF#);
         when others   => Valid := False;
      end case;
   end Convert;

   function From_ISO_8859_4 (Value : Character) return Code_Point is
   ...
   function From_ISO_8859_4 (Value : String) return String is
      Result  : String (1..Value'Length * 2);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_ISO_8859_4 (Value));
      end loop;
   ...
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_ISO_8859_4 (Value, Substitute));
      end loop;
      return Result (1..Pointer - 1);
   end From_ISO_8859_4;

   function From_ISO_8859_4 (Value : String) return Wide_String is
      Result  : Wide_String (1..Value'Length);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val (From_ISO_8859_4 (Value (Index)));
         Pointer := Pointer + 1;
      end loop;
      return Result;
   end From_ISO_8859_4;
   ...
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val
            (  From_ISO_8859_4 (Value (Index), Default)
            );
         Pointer := Pointer + 1;
      end loop;
      return Result;
   ...
   function To_ISO_8859_4 (Value : Code_Point) return Character is
      Result : Character;
      Valid  : Boolean;
   begin
   ...
   function To_ISO_8859_4 (Value : String) return String is
   ...
   begin
      while Pointer <= Value'Last loop
         ...
         Result (Index) := To_ISO_8859_4 (Code);
         Index := Index + 1;
      end loop;
   ...
   begin
      while Pointer <= Value'Last loop
         Get (Value, Pointer, Code);
         Result (Index) := To_ISO_8859_4 (Code, Substitute);
         Index := Index + 1;
      end loop;
      return Result (1..Index - 1);
   end To_ISO_8859_4;

   function To_ISO_8859_4 (Value : Wide_String) return String is
      Result : String (1..Value'Length);
      Index  : Integer := 1;
   begin
      for Pointer in Value'Range loop
         Result (Index) :=
            To_ISO_8859_4 (Wide_Character'Pos (Value (Pointer)));
         Index := Index + 1;
      end loop;
      return Result;
   end To_ISO_8859_4;
