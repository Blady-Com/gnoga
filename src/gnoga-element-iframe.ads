...
--                                                                          --
--                  G N O G A . E L E M E N T . I F R A M E                 --
--                                                                          --
--                                 S p e c                                  --
--                                                                          --
--                                                                          --
...
package Gnoga.Element.IFrame is
   ...
   type IFrame_Type is new Gnoga.Element.Element_Type with private;
   ...
   function Window (IFrame : IFrame_Type) return Gnoga.Window.Window_Access;

private
   type IFrame_Type is new Gnoga.Element.Element_Type with
      record
         Frame : aliased Gnoga.Window.Window_Type;
      end record;
end Gnoga.Element.IFrame;
