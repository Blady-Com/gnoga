...
use  Strings_Edit.UTF8.ISO_8859_10;

procedure Test_ISO_8859_10 is
begin
   for Code in Character range
      ...
      case Character'Pos (Code) is
         ...
         when others =>
            if To_ISO_8859_10 (From_ISO_8859_10 (Code)) /= Code then
               Raise_Exception
               (  Data_Error'Identity,
                  (  "Encoding "
                  &  Image (Integer (Character'Pos (Code)))
