...
package body GNAT.Sockets.Connection_State_Machine.ASN1.Bit_Strings.
   ...
   begin
      if State = 0 then
         Reset_Feed (Item, Data, Pointer);
         Check (Data (Pointer), (1 => Bit_String_Tag));
         Pointer     := Pointer + 1;
         Item.Length := 0;
         State       := Start_Length;
      ...
      Feed
      (  Item    => Implicit_Bit_String_Data_Item (Item),
         Data    => Data,
         Pointer => Pointer,
         Client  => Client,
         State   => State
   ...
   begin
      ...
      Feed
      (  Item    => Implicit_External_Bit_String_Data_Item (Item),
         Data    => Data,
         Pointer => Pointer,
         Client  => Client,
         State   => State
   ...
   function Is_Implicit (Item : Bit_String_Data_Item) return Boolean is
   begin
      return False;
   end Is_Implicit;
