...
package body Synchronization.Interprocess.Process_Call_Service.
   ...
   procedure Call
      ...
      begin
         Argument_Type'Output (Stream'Access, Argument);
      end Send_Parameters;
   ...
   procedure Call
      ...
      begin
         Argument_Type'Read (Stream'Access, Argument);
      end Receive_Results;
   ...
   begin
      if Method.Handler = null then
         ...
         Method.Handler
         (  Argument_Type'Input (Parameters'Access),
            Method.Service.all,
            Caller
         );
      end if;
   ...
   begin
      if Method.Handler = null then
         ...
         Argument_Type'Write (Results'Access, Argument);
      end if;
   end Execute;
