...
<<Done>>
   ...
   function Get (Storage : Blackboard; Pointer : Reference)
      ...
      Size   : Storage_Offset;
   begin
      if Pointer >= Load (Storage.Upper'Unchecked_Access) then
         raise Constraint_Error;
      end if;
      Size :=
      ...
      begin
         ...
         --
         if Pointer < Load (Storage.Lower'Unchecked_Access) then
            raise Constraint_Error;
         else
   ...
   function Is_Valid (Storage : Blackboard; Pointer : Reference)
      return Boolean is
   begin
      return Pointer >= Load (Storage.Lower'Unchecked_Access) and then
             Pointer <  Load (Storage.Upper'Unchecked_Access);
   end Is_Valid;
   ...
   function "<" (Storage : Blackboard; Pointer : Reference)
      return Boolean is
   begin
     return Load (Storage.Upper'Unchecked_Access) <= Pointer;
   end "<";

   function ">" (Storage : Blackboard; Pointer : Reference)
      return Boolean is
   begin
     return Load (Storage.Lower'Unchecked_Access) > Pointer;
   end ">";

   function "<" (Pointer : Reference; Storage : Blackboard)
      return Boolean is
   begin
     return Pointer < Load (Storage.Lower'Unchecked_Access);
   end "<";

   function ">" (Pointer : Reference; Storage : Blackboard)
      return Boolean is
   begin
     return Pointer >= Load (Storage.Upper'Unchecked_Access);
   end ">";
