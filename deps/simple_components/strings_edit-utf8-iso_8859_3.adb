...
--     Strings_Edit.UTF8.ISO_8859_3                Luebeck            --
...
package body Strings_Edit.UTF8.ISO_8859_3 is
   ...
   begin
      case Stream_Element (Character'Pos (Value)) is
         ...
         when 16#C5# => return 16#010A#;
         when 16#C6# => return 16#0108#;
         ...
         when 16#E5# => return 16#010B#;
         when 16#E6# => return 16#0109#;
   ...
   begin
      ...
      case Code is
         ...
         when 16#0125# => Value := Character'Val (16#B6#);
         when 16#00B7# => Value := Character'Val (16#B7#);
         when 16#00B8# => Value := Character'Val (16#B8#);
         when 16#0131# => Value := Character'Val (16#B9#);
         when 16#015F# => Value := Character'Val (16#BA#);
         when 16#011F# => Value := Character'Val (16#BB#);
         when 16#0135# => Value := Character'Val (16#BC#);
         ...
         when 16#010A# => Value := Character'Val (16#C5#);
         when 16#0108# => Value := Character'Val (16#C6#);
         ...
         when 16#0120# => Value := Character'Val (16#D5#);
         when 16#00D6# => Value := Character'Val (16#D6#);
         when 16#00D7# => Value := Character'Val (16#D7#);
         when 16#011C# => Value := Character'Val (16#D8#);
         ...
         when 16#016C# => Value := Character'Val (16#DD#);
         when 16#015C# => Value := Character'Val (16#DE#);
         ...
         when 16#010B# => Value := Character'Val (16#E5#);
         when 16#0109# => Value := Character'Val (16#E6#);
         ...
         when 16#0121# => Value := Character'Val (16#F5#);
         when 16#00F6# => Value := Character'Val (16#F6#);
         when 16#00F7# => Value := Character'Val (16#F7#);
         when 16#011D# => Value := Character'Val (16#F8#);
         ...
         when 16#016D# => Value := Character'Val (16#FD#);
         when 16#015D# => Value := Character'Val (16#FE#);
         when 16#02D9# => Value := Character'Val (16#FF#);
         when others   => Valid := False;
      end case;
   end Convert;

   function From_ISO_8859_3 (Value : Character) return Code_Point is
   ...
   function From_ISO_8859_3 (Value : String) return String is
      Result  : String (1..Value'Length * 2);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_ISO_8859_3 (Value));
      end loop;
   ...
   begin
      for Index in Value'Range loop
         Put (Result, Pointer, From_ISO_8859_3 (Value, Substitute));
      end loop;
      return Result (1..Pointer - 1);
   end From_ISO_8859_3;

   function From_ISO_8859_3 (Value : String) return Wide_String is
      Result  : Wide_String (1..Value'Length);
      Pointer : Integer := Result'First;
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val (From_ISO_8859_3 (Value (Index)));
         Pointer := Pointer + 1;
      end loop;
      return Result;
   end From_ISO_8859_3;
   ...
   begin
      for Index in Value'Range loop
         Result (Pointer) :=
            Wide_Character'Val
            (  From_ISO_8859_3 (Value (Index), Default)
            );
         Pointer := Pointer + 1;
      end loop;
      return Result;
   ...
   function To_ISO_8859_3 (Value : Code_Point) return Character is
      Result : Character;
      Valid  : Boolean;
   begin
   ...
   function To_ISO_8859_3 (Value : String) return String is
   ...
   begin
      while Pointer <= Value'Last loop
         ...
         Result (Index) := To_ISO_8859_3 (Code);
         Index := Index + 1;
      end loop;
   ...
   begin
      while Pointer <= Value'Last loop
         Get (Value, Pointer, Code);
         Result (Index) := To_ISO_8859_3 (Code, Substitute);
         Index := Index + 1;
      end loop;
      return Result (1..Index - 1);
   end To_ISO_8859_3;

   function To_ISO_8859_3 (Value : Wide_String) return String is
      Result : String (1..Value'Length);
      Index  : Integer := 1;
   begin
      for Pointer in Value'Range loop
         Result (Index) :=
            To_ISO_8859_3 (Wide_Character'Pos (Value (Pointer)));
         Index := Index + 1;
      end loop;
      return Result;
   end To_ISO_8859_3;
...
end Strings_Edit.UTF8.ISO_8859_3;
