...
--
--  ASN.1 encoding of modular integers
--
generic
   type Number is mod <>;
package GNAT.Sockets.Connection_State_Machine.ASN1.Generic_Unsigned is
--
-- Implicit_Unsigned_Data_Item -- ASN.1 encoded integer
--
...
--
   type Unsigned_Data_Item is
      new Implicit_Unsigned_Data_Item with null record;
--
-- Encode -- Overrides ...Connection_State_Machine.ASN1...
--
   procedure Encode
...
-- Is_Implicit -- Overrides ...Connection_State_Machine.ASN1...
--
   function Is_Implicit (Item : Unsigned_Data_Item) return Boolean;
------------------------------------------------------------------------
--
...
--    Length  - The length of integer encoding
--    Value   - The result
--
