   ...
   begin
      ...
      if Upper + Storage.Length > Storage.Size then
         ...
         if Lower >= Upper then
            ...
            -- |<Lower                                |
            --
            Moved := Storage.Lower + Reference (Storage.Size - Lower);
...
<<Done>>
   ...
   begin
      ...
      if Size <= 0 then
         ...
         if Index >= Storage.Upper then -- Wrapped to
            return;                     -- the end
         end if;
         Offset := 0;
         Size   := Get_Block_Size (Storage, Offset);
   ...
   begin
      ...
      Storage.Upper := Pointer + Reference (Storage.Length);
   end Put;
