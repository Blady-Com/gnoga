...
--  of various inter-process synchronization primitives. This is Windows
...
--
   ...
   type Head is record
      ...
      Initialized : Boolean;
      Owner       : DWORD;         -- The owner process ID
   end record;
   ...
   type Abstract_Shared_Environment is abstract
      new Ada.Finalization.Limited_Controlled with
   record
      File   : HANDLE    := INVALID_HANDLE_VALUE; -- Of mapping
      Server : HANDLE    := INVALID_HANDLE_VALUE; -- Of process
